  ...
  return (
    <div className='relative bg-gradient-to-br from-blue-200 to-purple-400 min-h-screen w-full flex items-center justify-center'>
      ...
      {/* Email input section */}
        ...
        <form  className='bg-slate-900 w-full rounded-lg h-fit flex flex-col items-center gap-3 py-6 px-4  ' >
        ...
        <form  className='bg-slate-900 w-full rounded-lg h-fit flex flex-col items-center gap-6 py-6 px-6  ' >
        ...
        <div className='w-[320px] sm:w-[350px] md:w-[370px]'>
          <form  className='bg-slate-900 w-full rounded-lg h-fit flex flex-col items-center gap-3 py-6 px-3  ' >
